        ...
        <div class="mx-auto px-6 lg:px-[60px] py-12">
            <div class="flex flex-col md:flex-row items-center justify-between gap-10">
                ...
                <nav class="flex flex-wrap justify-center gap-x-8 gap-y-4">
                    ...
                    <a href="/student2student/listings/ticket_listing.php" class="text-[0.9rem] font-bold text-[#64748B] hover:text-[#0052FF] transition-colors no-underline font-['Inter']">Sell Tickets</a>
    ...
    <div id="mobile-menu" class="fixed inset-0 z-[100] bg-white translate-x-full transition-transform duration-300 ease-in-out lg:hidden flex flex-col">
        ...
        <div class="flex-grow flex flex-col justify-between px-8 py-12">
            <nav class="flex flex-col space-y-8">
                ...
                <a href="/student2student/pages/events.php" class="text-4xl font-extrabold text-[#0A192F] no-underline font-['Inter'] tracking-tight">Events</a>
            </nav>
